/**
 * lib/email.js — ส่งอีเมลผ่าน Resend REST API
 * ต้องตั้ง env vars:
 *   RESEND_API_KEY = re_xxxxxxxx (จาก https://resend.com/api-keys)
 *   RESEND_FROM    = noreply@overseapengate.com (โดเมนต้อง verify ที่ Resend ก่อน)
 */

const SITE = 'https://www.overseapengate.com';
